...
/* 
Ici on appelle monsterHealthText parce que la variable monsterHealth 
est déjà appellée plus haut
*/
const monsterHealthText = document.querySelector("#monsterHealth");
 
// Création de variables objets pour les armes, les monstres et les boutons de gameplay. Optimisation répétition
...
//initialisation bouttons de base -> ref : goTown

button1.onclick = goStore;
button2.onclick = goCave;
button3.onclick = fightDragon;

// Vient adapté le texte et la fonctions au boutton selon sa place dans le tableau "locations"
...
//  Les 3 fonctions du Gameplay principal
...
function sellWeapon (){
    if (inventory.length > 1 ){
        gold += 15 ;
        goldText.innerText = gold;
        // Retire le premier element d'un tableau et le renvoie. Ici de "inventory"
        // J'appelle currentWeapon dans une fonction donc pas de doublon avec celle appellée en haut
...
function attack(){
    ...
    if (isMonsterHit()){
        ...
        /* let testHealth = Math.floor(Math.random() * xp) + 1;
    ...
    // L'arme peut cassée si echec critique (= ou > 0.1)
...
// Pour le plaisir d'un easter egg.
